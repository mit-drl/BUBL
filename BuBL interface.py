...
button_groups = {
    ...
    "Experiments - Swarm": [
        ...
        ("Record", "!NEPTUNE#[R,3,10]#!POSEIDON#[R,3,10]"),
        ("Stop Record", "!NEPTUNE#[R,0,10]#!POSEIDON#[R,0,10]"),
        ("Note Start Cal", "!NEPTUNE#[N,start_cal]#!POSEIDON#[N,start_cal]"),
        ("Note Stop Cal", "!NEPTUNE#[N,stop_cal]#!POSEIDON#[N,stop_cal]"),
        ("Note Start Test", "!NEPTUNE#[N,start_test]#!POSEIDON#[N,start_test]"),
        ("Note Stop Test", "!NEPTUNE#[N,stop_test]#!POSEIDON#[N,stop_test"),
        ("Forward", "!NEPTUNE#[C,1000,0,0]#!POSEIDON#[C,1000,0,0]"),
