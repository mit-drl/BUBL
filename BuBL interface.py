...
button_groups = {
    ...
    "Mapping": [
        ...
        ("Mapping", "[A,2,400,800,150,600,400,2,30,12,10,0.5,300,0]"),
        ("Mapping 15cm 10s", "[A,2,400,800,150,600,400,2,30,12,10,0.5,600,15]"),
        ("Mapping 30cm 10s", "[A,2,400,800,150,600,400,2,30,12,10,0.5,600,30]"),
        ("Mapping 15cm 1s", "[A,2,400,800,150,600,400,2,30,12,1,0.5,600,15]"),
        ("Mapping 30cm 1s", "[A,2,400,800,150,600,400,2,30,12,1,0.5,600,30]"),
        ("Stop Program", "[A,0]\n[C,0,0,0]\n[H]"),
    ],
